...
,@Context SecurityContext securityContext)
    ...
    public Response usersLogoutGet(@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.usersLogoutGet(securityContext);
    }
    @POST
    @Path("/signup")
    ...
    public Response usersSignupPost(@ApiParam(value = "credentials" ,required=true) Credentials1 credentials
,@Context SecurityContext securityContext)
    throws NotFoundException {
