...
,@Context SecurityContext securityContext)
    ...
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get all feeds subscribed by currend user", notes = "", response = Feed.class, responseContainer = "List", authorizations = {
        @io.swagger.annotations.Authorization(value = "api_key")
    }, tags={ "feed", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Feed.class, responseContainer = "List"),
        
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid tag value", response = Feed.class, responseContainer = "List") })
